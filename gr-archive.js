...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const STRINGS = {
    pt: {
      folderNames: { projects:'Projetos', tech:'Tecnologias', certs:'Certificados' },
    ...
    en: {
      folderNames: { projects:'Projects', tech:'Technologies', certs:'Certificates' },
  ...
  const LIBRARY = {
    pt: {
      projects:{label:'Projetos · arquivo de trabalho',items:[
        {title:'Bloody Mary',type:'Dados & automação · Python',description:'Extração e tratamento de registros de hemoterapia do SUS. Idealizei a solução e desenvolvi os módulos de coleta e limpeza.',record:'Dados do SUS',recordSub:'HEMOTERAPIA',recordBottom:'Python · RPA · ETL',url:'https://github.com/ribasgiovanna/datasus',link:'Ver repositório'},
        ...
        {title:'Monitor de Bueiros',type:'Protótipo IoT · ESP32 & Blynk',description:'Monitoramento de nível e alertas para explorar problemas da drenagem urbana. Projeto acadêmico em equipe.',image:'iot',caption:'painel em desenvolvimento'},
        ...
        {title:'Make a Pause',type:'Produto · Engenharia de requisitos',description:'Projeto acadêmico voltado à autorregulação da ansiedade. Uma proposta construída a partir de necessidades e funcionalidades.',pause:true},
        {title:'Doggo',type:'Projeto acadêmico · IoT',description:'Mais uma experiência com Internet das Coisas no meu percurso em Engenharia de Software.',record:'Doggo',recordSub:'PROJETO ACADÊMICO',recordBottom:'Internet das Coisas'}
      ]},
      tech:{label:'Tecnologias · ferramentas em uso',items:[
        {title:'Dados e automação',type:'Aplicação · Bloody Mary',description:'Ferramentas que uso para coletar, tratar e apresentar dados.',tools:['Python','pandas','Selenium','BeautifulSoup','Streamlit'],url:'https://github.com/ribasgiovanna/datasus',link:'Ver aplicação no projeto'},
        {title:'Desenvolvimento web',type:'Aplicação · Pibble Express',description:'Construção de interfaces, formulários e sistemas web.',tools:['HTML + CSS','JavaScript','Django','Django REST Framework'],url:'https://github.com/ribasgiovanna/pibble_express',link:'Ver aplicação no projeto'},
        ...
        {title:'Bancos de dados',type:'Consulta & organização',description:'Ferramentas presentes nos meus estudos e no desenvolvimento de sistemas.',tools:['SQL','PostgreSQL','SQL Server','SSMS']},
      ...
      certs:{label:'Certificados & formação · registros',items:[
        ...
        {title:'Problem Solving com IA',type:'HOTMILK · jan. 2026',description:'Participação em palestra no ecossistema de inovação da PUCPR.',image:'cert_hotmilk',caption:'certificado de participação'},
        ...
        {title:'Iniciação científica — FICEM',type:'Colégio Bom Jesus · 2024',description:'Pesquisa sobre a ciência dos sonhos, com produção da apresentação e do vídeo.',image:'cert_ficem',caption:'certificado de participação'},
        {title:'Imersão em inglês',type:'VGC International College · jan. 2024',description:'Winter Camp no Canadá.',image:'cert_vgc',caption:'certificado do Winter Camp'},
        {title:'Michigan English Test',type:'Michigan Language Assessment · fev. 2023',description:'MET — exame de proficiência em inglês.',image:'cert_met',caption:'certificado do MET'}
      ]}
    },
    en: {
      projects:{label:'Projects · working archive',items:[
        {title:'Bloody Mary',type:'Data & automation · Python',description:'Extraction and treatment of SUS hemotherapy records. I proposed the solution and built the collection and cleaning modules.',record:'SUS Data',recordSub:'HEMOTHERAPY',recordBottom:'Python · RPA · ETL',url:'https://github.com/ribasgiovanna/datasus',link:'View repository'},
        ...
        {title:'Monitor de Bueiros',type:'IoT prototype · ESP32 & Blynk',description:'Level monitoring and alerts to explore urban-drainage problems. Academic team project.',image:'iot',caption:'dashboard in progress'},
        ...
        {title:'Make a Pause',type:'Product · Requirements engineering',description:'Academic project focused on anxiety self-regulation. A proposal built from needs and features.',pause:true},
        {title:'Doggo',type:'Academic project · IoT',description:'Another Internet-of-Things experience along my Software Engineering path.',record:'Doggo',recordSub:'ACADEMIC PROJECT',recordBottom:'Internet of Things'}
      ]},
      tech:{label:'Technologies · tools in use',items:[
        {title:'Data & automation',type:'Application · Bloody Mary',description:'Tools I use to collect, clean and present data.',tools:['Python','pandas','Selenium','BeautifulSoup','Streamlit'],url:'https://github.com/ribasgiovanna/datasus',link:'See it applied in the project'},
        {title:'Web development',type:'Application · Pibble Express',description:'Building interfaces, forms and web systems.',tools:['HTML + CSS','JavaScript','Django','Django REST Framework'],url:'https://github.com/ribasgiovanna/pibble_express',link:'See it applied in the project'},
        ...
        {title:'Databases',type:'Querying & organization',description:'Tools present in my studies and in systems development.',tools:['SQL','PostgreSQL','SQL Server','SSMS']},
      ...
      certs:{label:'Certificates & education · records',items:[
        ...
        {title:'Problem Solving with AI',type:'HOTMILK · Jan. 2026',description:"Talk attended at PUCPR's innovation ecosystem.",image:'cert_hotmilk',caption:'participation certificate'},
        ...
        {title:'Iniciação científica — FICEM',type:'Colégio Bom Jesus · 2024',description:'Research on the science of dreams, including the presentation and video.',image:'cert_ficem',caption:'participation certificate'},
        {title:'English Immersion',type:'VGC International College · Jan. 2024',description:'Winter Camp in Canada.',image:'cert_vgc',caption:'Winter Camp certificate'},
        {title:'Michigan English Test',type:'Michigan Language Assessment · Feb. 2023',description:'MET — English proficiency exam.',image:'cert_met',caption:'MET certificate'}
      ]}
    }
  };
  ...
  function itemMarkup(item){
    ...
    return `<div class="gr-sheet-layout">${visual}<div class="gr-sheet-copy"><p class="gr-sheet-type">${escapeText(item.type)}</p><h3>${escapeText(item.title)}</h3><p class="gr-sheet-description">${escapeText(item.description)}</p>${item.url?`<a class="gr-sheet-link" href="${item.url}" target="_blank" rel="noopener noreferrer">${escapeText(item.link)} ↗</a>`:''}${item.credit?`<p class="gr-sheet-credit">${escapeText(item.credit)}</p>`:''}</div></div>`;
  }
